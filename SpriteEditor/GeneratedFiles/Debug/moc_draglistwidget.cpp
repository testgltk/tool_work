...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DragListWidget_t, stringdata) + ofs \
...
const QMetaObject DragListWidget::staticMetaObject = {
    { &QListWidget::staticMetaObject, qt_meta_stringdata_DragListWidget.data,
      qt_meta_data_DragListWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DragListWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DragListWidget.stringdata))
